...
class ThemeLoanUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_loan_ultimate_01_post_copy(self, mod):
        ...
        self.enable_view('theme_loan_ultimate_01.loan_theme_footer')
