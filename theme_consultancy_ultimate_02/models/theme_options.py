...
class ThemeConsultancyUltimate02_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_consultancy_ultimate_02_post_copy(self, mod):
        ...
        self.enable_view('theme_consultancy_ultimate_02.consultancy_theme_footer')
