...
class WebsiteSaleLazyLoad(WebsiteSale):

    @http.route(['/get/shop/lazy_load'], type='json', auth="public", website=True)
    def get_shop_lazy_load_products(self, page=0, category=None, search='', offset=False, ppg=False, **post):
        ...
        if TableCompute().process(products, ppg, ppr):
            return request.env['ir.ui.view']._render_template(
                'ultimate_website_sale_lazy_load.ultimate_website_sale_lazy_load_products', values)
        else:
            return False
