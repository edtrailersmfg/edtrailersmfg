    ...
    def validate_bills(self):
        ...
        for bill in bills:
            ...
            if not self.validate_duplicate_invoice(invoice['rfc'], invoice['amount_total'], invoice['date_invoice'], invoice['name']):
                ...
                attachment = self.attach_to_invoice(draft, bill['xml_file_data'], bill['filename'])
                ...
                xedi = edi_obj.create({'name' : invoice['name'],
                                       'state' : 'sent',
    ...
    def action_view_invoices(self, invoice_ids):
        ...
        if self.invoice_type == 'out_invoice':
            ...
            if len(invoice_ids) > 1:
                ...
                form_view_id = imd.xmlid_to_res_id('account.view_move_form')
                list_view_id = imd.xmlid_to_res_id('account.view_in_invoice_tree')
