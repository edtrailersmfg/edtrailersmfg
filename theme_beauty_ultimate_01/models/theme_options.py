...
class ThemeBeautyUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_beauty_ultimate_01_post_copy(self, mod):
        self.disable_view('website.template_header_default')
        self.enable_view('website_customize_theme_business_ul_73lines.template_navbar_1')
        self.enable_view('theme_beauty_ultimate_01.beauty_theme_footer')
