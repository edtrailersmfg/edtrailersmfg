...
class ThemeAppUltimate03_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_app_ultimate_03_post_copy(self, mod):
        self.disable_view('website.template_header_default')
        self.enable_view('website_customize_theme_business_ul_73lines.template_navbar_1')
        self.enable_view('theme_app_ultimate_03.app_three_theme_footer')
